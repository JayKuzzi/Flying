 ...
 * MyRecyclerAdapter
 */
public class OrderRecyclerAdapterInC extends RecyclerView.Adapter<OrderRecyclerAdapterInC.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        viewHolder.item_order_get_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog1.setPositiveButton("确定送达", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
